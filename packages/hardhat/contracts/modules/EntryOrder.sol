...
/// @notice Module used to execute entry orders create in the core contract
contract EntryOrders is IModule {
    ...
    function canExecute(
        ...
        return (success && bought >= minReturn && bought <= maxReturn);
    }
    ...
    function _transferAmount(
        ...
        if (address(_token) == ETH_ADDRESS) {
            ...
            require(success, "EntryOrders#_transferAmount: ETH_TRANSFER_FAILED");
        } else {
            require(SafeERC20.transfer(_token, _to, _amount), "EntryOrders#_transferAmount: TOKEN_TRANSFER_FAILED");
        }
    }
}